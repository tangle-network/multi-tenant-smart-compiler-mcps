...
cat >/etc/profile.d/00-toolchains.sh <<'EOF'
export CARGO_HOME="$HOME/.cargo"
export RUSTUP_HOME="$HOME/.rustup"
export PATH="/usr/local/cargo/bin:/usr/local/foundry/bin:/usr/local/risc0/bin:$PATH"
export PYTHONPATH="${PYTHONPATH:+$PYTHONPATH:}/usr/local/lib/python3.10/site-packages/"
EOF
