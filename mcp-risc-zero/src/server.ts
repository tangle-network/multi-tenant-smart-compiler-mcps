...
import { registerRiscZeroTools } from "./domains/risc-zero/index.js";
import {
  initCastTools,
  initAnvilTools,
  initFoundryTools,
...
export const createServer = async (app: ExpressApp) => {
  const server = new McpServer(
    {
      name: "Risc Zero zkVM Agent MCP Server",
      version: "1.0.0",
    },
    {
      capabilities: {
  ...
  // Register resources and tools for the risc-zero project
  registerRiscZeroTools(server);
